...
class BoothOneIssues extends StatefulWidget {
  const BoothOneIssues({super.key});

  @override
  State<BoothOneIssues> createState() => _BoothOneIssuesState();
}

class _BoothOneIssuesState extends State<BoothOneIssues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('clients');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 1",style: TextStyle(
