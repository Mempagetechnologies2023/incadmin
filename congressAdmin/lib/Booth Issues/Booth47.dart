...
class Booth47Issues extends StatefulWidget {
  const Booth47Issues({super.key});

  @override
  State<Booth47Issues> createState() => _Booth47IssuesState();
}

class _Booth47IssuesState extends State<Booth47Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth47');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 47",style: TextStyle(
