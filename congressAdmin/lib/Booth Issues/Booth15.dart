...
class Booth15Issues extends StatefulWidget {
  const Booth15Issues({super.key});

  @override
  State<Booth15Issues> createState() => _Booth15IssuesState();
}

class _Booth15IssuesState extends State<Booth15Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth15');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 15",style: TextStyle(
