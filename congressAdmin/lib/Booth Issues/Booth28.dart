...
class Booth28Issues extends StatefulWidget {
  const Booth28Issues({super.key});

  @override
  State<Booth28Issues> createState() => _Booth28IssuesState();
}

class _Booth28IssuesState extends State<Booth28Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth28');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 28",style: TextStyle(
