...
class BoothEightIssues extends StatefulWidget {
  const BoothEightIssues({super.key});

  @override
  State<BoothEightIssues> createState() => _BoothEightIssuesState();
}

class _BoothEightIssuesState extends State<BoothEightIssues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth8');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 8",style: TextStyle(
