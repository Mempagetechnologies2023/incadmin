...
class Booth43Issues extends StatefulWidget {
  const Booth43Issues({super.key});

  @override
  State<Booth43Issues> createState() => _Booth43IssuesState();
}

class _Booth43IssuesState extends State<Booth43Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth43');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 43",style: TextStyle(
