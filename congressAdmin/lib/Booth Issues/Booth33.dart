...
class Booth33Issues extends StatefulWidget {
  const Booth33Issues({super.key});

  @override
  State<Booth33Issues> createState() => _Booth33IssuesState();
}

class _Booth33IssuesState extends State<Booth33Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth33');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 33",style: TextStyle(
