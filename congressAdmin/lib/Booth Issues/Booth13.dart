...
class Booth13Issues extends StatefulWidget {
  const Booth13Issues({super.key});

  @override
  State<Booth13Issues> createState() => _Booth13IssuesState();
}

class _Booth13IssuesState extends State<Booth13Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth13');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 13",style: TextStyle(
