...
class Booth41Issues extends StatefulWidget {
  const Booth41Issues({super.key});

  @override
  State<Booth41Issues> createState() => _Booth41IssuesState();
}

class _Booth41IssuesState extends State<Booth41Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth41');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 41",style: TextStyle(
