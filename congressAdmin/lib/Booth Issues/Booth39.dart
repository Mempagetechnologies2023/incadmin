...
class Booth39Issues extends StatefulWidget {
  const Booth39Issues({super.key});

  @override
  State<Booth39Issues> createState() => _Booth39IssuesState();
}

class _Booth39IssuesState extends State<Booth39Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth39');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 39",style: TextStyle(
