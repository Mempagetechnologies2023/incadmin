...
class Booth22Issues extends StatefulWidget {
  const Booth22Issues({super.key});

  @override
  State<Booth22Issues> createState() => _Booth22IssuesState();
}

class _Booth22IssuesState extends State<Booth22Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth22');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 22",style: TextStyle(
