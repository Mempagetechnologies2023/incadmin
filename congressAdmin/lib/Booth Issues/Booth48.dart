...
class Booth48Issues extends StatefulWidget {
  const Booth48Issues({super.key});

  @override
  State<Booth48Issues> createState() => _Booth48IssuesState();
}

class _Booth48IssuesState extends State<Booth48Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth48');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 48",style: TextStyle(
