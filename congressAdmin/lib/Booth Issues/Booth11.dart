...
class Booth11Issues extends StatefulWidget {
  const Booth11Issues({super.key});

  @override
  State<Booth11Issues> createState() => _Booth11IssuesState();
}

class _Booth11IssuesState extends State<Booth11Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth11');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 11",style: TextStyle(
