...
class BoothThreeIssues extends StatefulWidget {
  const BoothThreeIssues({super.key});

  @override
  State<BoothThreeIssues> createState() => _BoothThreeIssuesState();
}

class _BoothThreeIssuesState extends State<BoothThreeIssues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth3');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 3",style: TextStyle(
