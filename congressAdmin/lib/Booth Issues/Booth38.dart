...
class Booth38Issues extends StatefulWidget {
  const Booth38Issues({super.key});

  @override
  State<Booth38Issues> createState() => _Booth38IssuesState();
}

class _Booth38IssuesState extends State<Booth38Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth38');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 38",style: TextStyle(
