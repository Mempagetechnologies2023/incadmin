...
class Booth40Issues extends StatefulWidget {
  const Booth40Issues({super.key});

  @override
  State<Booth40Issues> createState() => _Booth40IssuesState();
}

class _Booth40IssuesState extends State<Booth40Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth40');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 40",style: TextStyle(
