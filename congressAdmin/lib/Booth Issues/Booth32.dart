...
class Booth32Issues extends StatefulWidget {
  const Booth32Issues({super.key});

  @override
  State<Booth32Issues> createState() => _Booth32IssuesState();
}

class _Booth32IssuesState extends State<Booth32Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth32');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 32",style: TextStyle(
