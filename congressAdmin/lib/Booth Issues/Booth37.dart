...
class Booth37Issues extends StatefulWidget {
  const Booth37Issues({super.key});

  @override
  State<Booth37Issues> createState() => _Booth37IssuesState();
}

class _Booth37IssuesState extends State<Booth37Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth37');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 37",style: TextStyle(
