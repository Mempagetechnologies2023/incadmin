...
class Booth16Issues extends StatefulWidget {
  const Booth16Issues({super.key});

  @override
  State<Booth16Issues> createState() => _Booth16IssuesState();
}

class _Booth16IssuesState extends State<Booth16Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth16');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 16",style: TextStyle(
