...
class Booth34Issues extends StatefulWidget {
  const Booth34Issues({super.key});

  @override
  State<Booth34Issues> createState() => _Booth34IssuesState();
}

class _Booth34IssuesState extends State<Booth34Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth34');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 34",style: TextStyle(
