...
class Booth44Issues extends StatefulWidget {
  const Booth44Issues({super.key});

  @override
  State<Booth44Issues> createState() => _Booth44IssuesState();
}

class _Booth44IssuesState extends State<Booth44Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth44');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 44",style: TextStyle(
