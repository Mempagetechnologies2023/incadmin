...
class BoothTenIssues extends StatefulWidget {
  const BoothTenIssues({super.key});

  @override
  State<BoothTenIssues> createState() => _BoothTenIssuesState();
}

class _BoothTenIssuesState extends State<BoothTenIssues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth10');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 10",style: TextStyle(
