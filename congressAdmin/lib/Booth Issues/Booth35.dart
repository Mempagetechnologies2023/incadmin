...
class Booth35Issues extends StatefulWidget {
  const Booth35Issues({super.key});

  @override
  State<Booth35Issues> createState() => _Booth35IssuesState();
}

class _Booth35IssuesState extends State<Booth35Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth35');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 35",style: TextStyle(
