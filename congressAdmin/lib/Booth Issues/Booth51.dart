...
class Booth51Issues extends StatefulWidget {
  const Booth51Issues({super.key});

  @override
  State<Booth51Issues> createState() => _Booth51IssuesState();
}

class _Booth51IssuesState extends State<Booth51Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth51');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 51",style: TextStyle(
