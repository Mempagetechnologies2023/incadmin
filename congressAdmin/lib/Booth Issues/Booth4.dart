...
class BoothFourIssues extends StatefulWidget {
  const BoothFourIssues({super.key});

  @override
  State<BoothFourIssues> createState() => _BoothFourIssuesState();
}

class _BoothFourIssuesState extends State<BoothFourIssues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth4');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 4",style: TextStyle(
