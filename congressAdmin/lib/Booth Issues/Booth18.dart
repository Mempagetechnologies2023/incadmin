...
class Booth18Issues extends StatefulWidget {
  const Booth18Issues({super.key});

  @override
  State<Booth18Issues> createState() => _Booth18IssuesState();
}

class _Booth18IssuesState extends State<Booth18Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth18');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 18",style: TextStyle(
