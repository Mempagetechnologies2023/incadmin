...
class Booth24Issues extends StatefulWidget {
  const Booth24Issues({super.key});

  @override
  State<Booth24Issues> createState() => _Booth24IssuesState();
}

class _Booth24IssuesState extends State<Booth24Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth24');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 24",style: TextStyle(
