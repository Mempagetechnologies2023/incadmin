...
class Booth19Issues extends StatefulWidget {
  const Booth19Issues({super.key});

  @override
  State<Booth19Issues> createState() => _Booth19IssuesState();
}

class _Booth19IssuesState extends State<Booth19Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth19');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 19",style: TextStyle(
