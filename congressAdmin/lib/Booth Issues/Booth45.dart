...
class Booth45Issues extends StatefulWidget {
  const Booth45Issues({super.key});

  @override
  State<Booth45Issues> createState() => _Booth45IssuesState();
}

class _Booth45IssuesState extends State<Booth45Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth45');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 45",style: TextStyle(
