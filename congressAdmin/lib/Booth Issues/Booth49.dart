...
class Booth49Issues extends StatefulWidget {
  const Booth49Issues({super.key});

  @override
  State<Booth49Issues> createState() => _Booth49IssuesState();
}

class _Booth49IssuesState extends State<Booth49Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth49');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 49",style: TextStyle(
