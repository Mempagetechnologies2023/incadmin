...
class Booth31Issues extends StatefulWidget {
  const Booth31Issues({super.key});

  @override
  State<Booth31Issues> createState() => _Booth31IssuesState();
}

class _Booth31IssuesState extends State<Booth31Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth31');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 31",style: TextStyle(
