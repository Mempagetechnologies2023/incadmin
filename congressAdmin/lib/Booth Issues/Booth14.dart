...
class Booth14Issues extends StatefulWidget {
  const Booth14Issues({super.key});

  @override
  State<Booth14Issues> createState() => _Booth14IssuesState();
}

class _Booth14IssuesState extends State<Booth14Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth14');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 14",style: TextStyle(
