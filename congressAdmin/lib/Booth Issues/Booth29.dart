...
class Booth29Issues extends StatefulWidget {
  const Booth29Issues({super.key});

  @override
  State<Booth29Issues> createState() => _Booth29IssuesState();
}

class _Booth29IssuesState extends State<Booth29Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth29');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 29",style: TextStyle(
