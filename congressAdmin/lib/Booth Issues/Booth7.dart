...
class BoothSevenIssues extends StatefulWidget {
  const BoothSevenIssues({super.key});

  @override
  State<BoothSevenIssues> createState() => _BoothSevenIssuesState();
}

class _BoothSevenIssuesState extends State<BoothSevenIssues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth7');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 7",style: TextStyle(
