...
class Booth50Issues extends StatefulWidget {
  const Booth50Issues({super.key});

  @override
  State<Booth50Issues> createState() => _Booth50IssuesState();
}

class _Booth50IssuesState extends State<Booth50Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth50');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 50",style: TextStyle(
