...
class Booth12Issues extends StatefulWidget {
  const Booth12Issues({super.key});

  @override
  State<Booth12Issues> createState() => _Booth12IssuesState();
}

class _Booth12IssuesState extends State<Booth12Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth12');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 12",style: TextStyle(
