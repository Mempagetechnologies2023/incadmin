...
class Booth26Issues extends StatefulWidget {
  const Booth26Issues({super.key});

  @override
  State<Booth26Issues> createState() => _Booth26IssuesState();
}

class _Booth26IssuesState extends State<Booth26Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth26');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 26",style: TextStyle(
