...
class BoothNineIssues extends StatefulWidget {
  const BoothNineIssues({super.key});

  @override
  State<BoothNineIssues> createState() => _BoothNineIssuesState();
}

class _BoothNineIssuesState extends State<BoothNineIssues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth9');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 9",style: TextStyle(
