...
class Booth17Issues extends StatefulWidget {
  const Booth17Issues({super.key});

  @override
  State<Booth17Issues> createState() => _Booth17IssuesState();
}

class _Booth17IssuesState extends State<Booth17Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth17');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 17",style: TextStyle(
