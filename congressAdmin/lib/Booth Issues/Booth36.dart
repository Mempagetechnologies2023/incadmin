...
class Booth36Issues extends StatefulWidget {
  const Booth36Issues({super.key});

  @override
  State<Booth36Issues> createState() => _Booth36IssuesState();
}

class _Booth36IssuesState extends State<Booth36Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth36');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 36",style: TextStyle(
