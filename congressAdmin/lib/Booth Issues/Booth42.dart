...
class Booth42Issues extends StatefulWidget {
  const Booth42Issues({super.key});

  @override
  State<Booth42Issues> createState() => _Booth42IssuesState();
}

class _Booth42IssuesState extends State<Booth42Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth42');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 42",style: TextStyle(
