...
class Booth46Issues extends StatefulWidget {
  const Booth46Issues({super.key});

  @override
  State<Booth46Issues> createState() => _Booth46IssuesState();
}

class _Booth46IssuesState extends State<Booth46Issues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth46');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 46",style: TextStyle(
