...
class BoothSixIssues extends StatefulWidget {
  const BoothSixIssues({super.key});

  @override
  State<BoothSixIssues> createState() => _BoothSixIssuesState();
}

class _BoothSixIssuesState extends State<BoothSixIssues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth6');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("$_partyBoothtitleText 6",style: TextStyle(
