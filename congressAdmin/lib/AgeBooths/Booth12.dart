...
class Booth12Data extends StatefulWidget {
  const Booth12Data({super.key});

  @override
  State<Booth12Data> createState() => _Booth12DataState();
}

class _Booth12DataState extends State<Booth12Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 12",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth12').get(),
