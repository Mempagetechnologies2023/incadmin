...
class Booth44Data extends StatefulWidget {
  const Booth44Data({super.key});

  @override
  State<Booth44Data> createState() => _Booth44DataState();
}

class _Booth44DataState extends State<Booth44Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 44",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth44').get(),
