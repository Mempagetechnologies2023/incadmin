...
class Booth14Data extends StatefulWidget {
  const Booth14Data({super.key});

  @override
  State<Booth14Data> createState() => _Booth14DataState();
}

class _Booth14DataState extends State<Booth14Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 14",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth14').get(),
