...
class Booth34Data extends StatefulWidget {
  const Booth34Data({super.key});

  @override
  State<Booth34Data> createState() => _Booth34DataState();
}

class _Booth34DataState extends State<Booth34Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 34",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth34').get(),
