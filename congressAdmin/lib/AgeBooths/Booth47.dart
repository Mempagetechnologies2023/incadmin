...
class Booth47Data extends StatefulWidget {
  const Booth47Data({super.key});

  @override
  State<Booth47Data> createState() => _Booth47DataState();
}

class _Booth47DataState extends State<Booth47Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 47",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth47').get(),
