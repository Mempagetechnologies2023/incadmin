...
class BoothSevenData extends StatefulWidget {
  const BoothSevenData({super.key});

  @override
  State<BoothSevenData> createState() => _BoothSevenDataState();
}

class _BoothSevenDataState extends State<BoothSevenData> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 7",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth7').get(),
