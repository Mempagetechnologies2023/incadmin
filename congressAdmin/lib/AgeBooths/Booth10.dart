...
class BoothTenData extends StatefulWidget {
  const BoothTenData({super.key});

  @override
  State<BoothTenData> createState() => _BoothTenDataState();
}

class _BoothTenDataState extends State<BoothTenData> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 10",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth10').get(),
