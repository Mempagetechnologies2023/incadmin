...
class Booth27Data extends StatefulWidget {
  const Booth27Data({super.key});

  @override
  State<Booth27Data> createState() => _Booth27DataState();
}

class _Booth27DataState extends State<Booth27Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 27",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth27').get(),
