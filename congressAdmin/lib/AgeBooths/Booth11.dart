...
class Booth11Data extends StatefulWidget {
  const Booth11Data({super.key});

  @override
  State<Booth11Data> createState() => _Booth11DataState();
}

class _Booth11DataState extends State<Booth11Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 11",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth11').get(),
