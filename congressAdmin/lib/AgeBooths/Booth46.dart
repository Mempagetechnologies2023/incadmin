...
class Booth46Data extends StatefulWidget {
  const Booth46Data({super.key});

  @override
  State<Booth46Data> createState() => _Booth46DataState();
}

class _Booth46DataState extends State<Booth46Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 46",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth46').get(),
