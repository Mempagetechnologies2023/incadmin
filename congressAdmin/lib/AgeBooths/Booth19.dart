...
class Booth19Data extends StatefulWidget {
  const Booth19Data({super.key});

  @override
  State<Booth19Data> createState() => _Booth19DataState();
}

class _Booth19DataState extends State<Booth19Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 19",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth19').get(),
