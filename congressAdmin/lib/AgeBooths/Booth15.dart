...
class Booth15Data extends StatefulWidget {
  const Booth15Data({super.key});

  @override
  State<Booth15Data> createState() => _Booth15DataState();
}

class _Booth15DataState extends State<Booth15Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 15",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth15').get(),
