...
class Booth21Data extends StatefulWidget {
  const Booth21Data({super.key});

  @override
  State<Booth21Data> createState() => _Booth21DataState();
}

class _Booth21DataState extends State<Booth21Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 21",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth21').get(),
