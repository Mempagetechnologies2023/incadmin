...
class BoothThreeData extends StatefulWidget {
  const BoothThreeData({super.key});

  @override
  State<BoothThreeData> createState() => _BoothThreeDataState();
}

class _BoothThreeDataState extends State<BoothThreeData> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 3",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth3').get(),
