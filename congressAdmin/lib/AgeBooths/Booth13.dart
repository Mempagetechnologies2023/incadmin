...
class Booth13Data extends StatefulWidget {
  const Booth13Data({super.key});

  @override
  State<Booth13Data> createState() => _Booth13DataState();
}

class _Booth13DataState extends State<Booth13Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 13",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth13').get(),
