...
class BoothFiveData extends StatefulWidget {
  const BoothFiveData({Key? key}) : super(key: key);

  @override
  State<BoothFiveData> createState() => _BoothFiveDataState();
}

class _BoothFiveDataState extends State<BoothFiveData> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 5",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth5').get(),
