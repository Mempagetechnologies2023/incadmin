...
class Booth37Data extends StatefulWidget {
  const Booth37Data({super.key});

  @override
  State<Booth37Data> createState() => _Booth37DataState();
}

class _Booth37DataState extends State<Booth37Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 37",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth37').get(),
