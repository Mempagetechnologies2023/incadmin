...
class Booth39Data extends StatefulWidget {
  const Booth39Data({super.key});

  @override
  State<Booth39Data> createState() => _Booth39DataState();
}

class _Booth39DataState extends State<Booth39Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 39",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth39').get(),
