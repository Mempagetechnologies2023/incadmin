...
class Booth18Data extends StatefulWidget {
  const Booth18Data({super.key});

  @override
  State<Booth18Data> createState() => _Booth18DataState();
}

class _Booth18DataState extends State<Booth18Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 18",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth18').get(),
