...
class Booth50Data extends StatefulWidget {
    Booth50Data({super.key});

  @override
  State<Booth50Data> createState() => _Booth50DataState();
}

class _Booth50DataState extends State<Booth50Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 50",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth50').get(),
