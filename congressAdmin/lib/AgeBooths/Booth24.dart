...
class Booth24Data extends StatefulWidget {
  const Booth24Data({super.key});

  @override
  State<Booth24Data> createState() => _Booth24DataState();
}

class _Booth24DataState extends State<Booth24Data> {
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth24').get(),
