...
class BoothNineData extends StatefulWidget {
  const BoothNineData({super.key});

  @override
  State<BoothNineData> createState() => _BoothNineDataState();
}

class _BoothNineDataState extends State<BoothNineData> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 9",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth9').get(),
