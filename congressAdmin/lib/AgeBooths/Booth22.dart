...
class Booth22Data extends StatefulWidget {
  const Booth22Data({super.key});

  @override
  State<Booth22Data> createState() => _Booth22DataState();
}

class _Booth22DataState extends State<Booth22Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 22",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth22').get(),
