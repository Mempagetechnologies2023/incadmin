...
class Booth31Data extends StatefulWidget {
  const Booth31Data({super.key});

  @override
  State<Booth31Data> createState() => _Booth31DataState();
}

class _Booth31DataState extends State<Booth31Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 31",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth31').get(),
