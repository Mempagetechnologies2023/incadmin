...
class Booth38Data extends StatefulWidget {
  const Booth38Data({super.key});

  @override
  State<Booth38Data> createState() => _Booth38DataState();
}

class _Booth38DataState extends State<Booth38Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 38",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth38').get(),
