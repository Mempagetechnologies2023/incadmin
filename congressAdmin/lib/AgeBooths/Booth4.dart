...
class BoothFourData extends StatefulWidget {
  const BoothFourData({super.key});

  @override
  State<BoothFourData> createState() => _BoothFourDataState();
}

class _BoothFourDataState extends State<BoothFourData> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 4",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth4').get(),
