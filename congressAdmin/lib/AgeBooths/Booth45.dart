...
class Booth45Data extends StatefulWidget {
  const Booth45Data({super.key});

  @override
  State<Booth45Data> createState() => _Booth45DataState();
}

class _Booth45DataState extends State<Booth45Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 45",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth45').get(),
