...
class Booth20Data extends StatefulWidget {
  const Booth20Data({super.key});

  @override
  State<Booth20Data> createState() => _Booth20DataState();
}

class _Booth20DataState extends State<Booth20Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 20",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth20').get(),
