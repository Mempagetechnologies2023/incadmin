...
class BoothTwoData extends StatefulWidget {
  const BoothTwoData({super.key});

  @override
  State<BoothTwoData> createState() => _BoothTwoDataState();
}

class _BoothTwoDataState extends State<BoothTwoData> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 2",
