...
class BoothSixData extends StatefulWidget {
  const BoothSixData({super.key});

  @override
  State<BoothSixData> createState() => _BoothSixDataState();
}

class _BoothSixDataState extends State<BoothSixData> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 6",
