...
class Booth48Data extends StatefulWidget {
  const Booth48Data({super.key});

  @override
  State<Booth48Data> createState() => _Booth48DataState();
}

class _Booth48DataState extends State<Booth48Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 48",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth48').get(),
