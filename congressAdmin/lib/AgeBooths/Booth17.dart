...
class Booth17Data extends StatefulWidget {
  const Booth17Data({super.key});

  @override
  State<Booth17Data> createState() => _Booth17DataState();
}

class _Booth17DataState extends State<Booth17Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 17",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth17').get(),
