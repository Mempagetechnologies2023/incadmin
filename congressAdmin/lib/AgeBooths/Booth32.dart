...
class Booth32Data extends StatefulWidget {
  const Booth32Data({super.key});

  @override
  State<Booth32Data> createState() => _Booth32DataState();
}

class _Booth32DataState extends State<Booth32Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 32",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth32').get(),
