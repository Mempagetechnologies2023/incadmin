...
class Booth43Data extends StatefulWidget {
  const Booth43Data({super.key});

  @override
  State<Booth43Data> createState() => _Booth43DataState();
}

class _Booth43DataState extends State<Booth43Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 43",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth43').get(),
