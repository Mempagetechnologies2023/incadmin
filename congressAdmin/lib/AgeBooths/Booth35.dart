...
class Booth35Data extends StatefulWidget {
  const Booth35Data({super.key});

  @override
  State<Booth35Data> createState() => _Booth35DataState();
}

class _Booth35DataState extends State<Booth35Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 35",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth35').get(),
