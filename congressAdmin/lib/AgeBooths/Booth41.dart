...
class Booth41Data extends StatefulWidget {
  const Booth41Data({super.key});

  @override
  State<Booth41Data> createState() => _Booth41DataState();
}

class _Booth41DataState extends State<Booth41Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 41",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth41').get(),
