...
class Booth40Data extends StatefulWidget {
  const Booth40Data({super.key});

  @override
  State<Booth40Data> createState() => _Booth40DataState();
}

class _Booth40DataState extends State<Booth40Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 40",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth40').get(),
