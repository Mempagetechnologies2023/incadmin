...
class Booth33Data extends StatefulWidget {
  const Booth33Data({super.key});

  @override
  State<Booth33Data> createState() => _Booth33DataState();
}

class _Booth33DataState extends State<Booth33Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 33",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth33').get(),
