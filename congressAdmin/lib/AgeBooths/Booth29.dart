...
class Booth29Data extends StatefulWidget {
  const Booth29Data({super.key});

  @override
  State<Booth29Data> createState() => _Booth29DataState();
}

class _Booth29DataState extends State<Booth29Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 29",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth29').get(),
