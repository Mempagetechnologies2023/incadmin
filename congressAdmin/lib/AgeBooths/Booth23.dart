...
class Booth23Data extends StatefulWidget {
  const Booth23Data({super.key});

  @override
  State<Booth23Data> createState() => _Booth23DataState();
}

class _Booth23DataState extends State<Booth23Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 23",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth23').get(),
