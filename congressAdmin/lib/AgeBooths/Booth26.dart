...
class Booth26Data extends StatefulWidget {
  const Booth26Data({super.key});

  @override
  State<Booth26Data> createState() => _Booth26DataState();
}

class _Booth26DataState extends State<Booth26Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 26",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth26').get(),
