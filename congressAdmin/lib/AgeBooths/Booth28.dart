...
class Booth28Data extends StatefulWidget {
  const Booth28Data({super.key});

  @override
  State<Booth28Data> createState() => _Booth28DataState();
}

class _Booth28DataState extends State<Booth28Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 28",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth28').get(),
