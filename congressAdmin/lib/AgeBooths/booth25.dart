...
class Booth25Data extends StatefulWidget {
  const Booth25Data({super.key});

  @override
  State<Booth25Data> createState() => _Booth25DataState();
}

class _Booth25DataState extends State<Booth25Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 25",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth25').get(),
