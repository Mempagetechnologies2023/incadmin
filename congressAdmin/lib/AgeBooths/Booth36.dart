...
class Booth36Data extends StatefulWidget {
  const Booth36Data({super.key});

  @override
  State<Booth36Data> createState() => _Booth36DataState();
}

class _Booth36DataState extends State<Booth36Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 36",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth36').get(),
