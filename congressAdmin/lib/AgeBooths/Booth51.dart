...
class Booth51Data extends StatefulWidget {
  Booth51Data({super.key});

  @override
  State<Booth51Data> createState() => _Booth51DataState();
}

class _Booth51DataState extends State<Booth51Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 51",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth51').get(),
