...
class Booth30Data extends StatefulWidget {
  const Booth30Data({super.key});

  @override
  State<Booth30Data> createState() => _Booth30DataState();
}

class _Booth30DataState extends State<Booth30Data> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 30",
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance.collection('booth30').get(),
