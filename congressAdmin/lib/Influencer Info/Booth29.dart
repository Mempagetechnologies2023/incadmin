...
class Booth29Info extends StatefulWidget {
  const Booth29Info({super.key});

  @override
  State<Booth29Info> createState() => _Booth29InfoState();
}

class _Booth29InfoState extends State<Booth29Info> {
