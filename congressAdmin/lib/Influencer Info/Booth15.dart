...
class Booth15Info extends StatefulWidget {
  const Booth15Info({super.key});

  @override
  State<Booth15Info> createState() => _Booth15InfoState();
}

class _Booth15InfoState extends State<Booth15Info> {
