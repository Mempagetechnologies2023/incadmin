...
class Booth34Info extends StatefulWidget {
  const Booth34Info({super.key});

  @override
  State<Booth34Info> createState() => _Booth34InfoState();
}

class _Booth34InfoState extends State<Booth34Info> {
