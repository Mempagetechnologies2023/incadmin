...
class Booth35Info extends StatefulWidget {
  const Booth35Info({super.key});

  @override
  State<Booth35Info> createState() => _Booth35InfoState();
}

class _Booth35InfoState extends State<Booth35Info> {
