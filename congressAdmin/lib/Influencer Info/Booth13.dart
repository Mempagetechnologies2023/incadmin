...
class Booth13Info extends StatefulWidget {
  const Booth13Info({super.key});

  @override
  State<Booth13Info> createState() => _Booth13InfoState();
}

class _Booth13InfoState extends State<Booth13Info> {
