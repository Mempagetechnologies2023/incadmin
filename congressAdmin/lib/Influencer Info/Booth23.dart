...
class Booth23Info extends StatefulWidget {
  const Booth23Info({super.key});

  @override
  State<Booth23Info> createState() => _Booth23InfoState();
}

class _Booth23InfoState extends State<Booth23Info> {
