...
class BoothTenInfo extends StatefulWidget {
  const BoothTenInfo({super.key});

  @override
  State<BoothTenInfo> createState() => _BoothTenInfoState();
}

class _BoothTenInfoState extends State<BoothTenInfo> {
