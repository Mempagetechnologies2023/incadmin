...
class Booth33Info extends StatefulWidget {
  const Booth33Info({super.key});

  @override
  State<Booth33Info> createState() => _Booth33InfoState();
}

class _Booth33InfoState extends State<Booth33Info> {
