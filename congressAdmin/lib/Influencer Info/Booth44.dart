...
class Booth44Info extends StatefulWidget {
  const Booth44Info({super.key});

  @override
  State<Booth44Info> createState() => _Booth44InfoState();
}

class _Booth44InfoState extends State<Booth44Info> {
