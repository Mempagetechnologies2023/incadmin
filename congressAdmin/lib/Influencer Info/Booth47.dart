...
class Booth47Info extends StatefulWidget {
  const Booth47Info({super.key});

  @override
  State<Booth47Info> createState() => _Booth47InfoState();
}

class _Booth47InfoState extends State<Booth47Info> {
