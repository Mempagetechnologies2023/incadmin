...
class BoothEightInfo extends StatefulWidget {
  const BoothEightInfo({super.key});

  @override
  State<BoothEightInfo> createState() => _BoothEightInfoState();
}

class _BoothEightInfoState extends State<BoothEightInfo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text(
          "$_partytitleText $_partyBoothtitleText 8",
          style: TextStyle(
