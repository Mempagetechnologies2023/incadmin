...
class Booth40Info extends StatefulWidget {
  const Booth40Info({super.key});

  @override
  State<Booth40Info> createState() => _Booth40InfoState();
}

class _Booth40InfoState extends State<Booth40Info> {
