...
class Booth49Info extends StatefulWidget {
  const Booth49Info({super.key});

  @override
  State<Booth49Info> createState() => _Booth49InfoState();
}

class _Booth49InfoState extends State<Booth49Info> {
