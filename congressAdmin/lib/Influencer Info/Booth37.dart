...
class Booth37Info extends StatefulWidget {
  const Booth37Info({super.key});

  @override
  State<Booth37Info> createState() => _Booth37InfoState();
}

class _Booth37InfoState extends State<Booth37Info> {
