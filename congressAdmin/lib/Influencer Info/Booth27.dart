...
class Booth27Info extends StatefulWidget {
  const Booth27Info({super.key});

  @override
  State<Booth27Info> createState() => _Booth27InfoState();
}

class _Booth27InfoState extends State<Booth27Info> {
