...
class Booth11Info extends StatefulWidget {
  const Booth11Info({super.key});

  @override
  State<Booth11Info> createState() => _Booth11InfoState();
}

class _Booth11InfoState extends State<Booth11Info> {
