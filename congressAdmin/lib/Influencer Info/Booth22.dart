...
class Booth22Info extends StatefulWidget {
  const Booth22Info({super.key});

  @override
  State<Booth22Info> createState() => _Booth22InfoState();
}

class _Booth22InfoState extends State<Booth22Info> {
