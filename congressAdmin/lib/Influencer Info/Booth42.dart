...
class Booth42Info extends StatefulWidget {
  const Booth42Info({super.key});

  @override
  State<Booth42Info> createState() => _Booth42InfoState();
}

class _Booth42InfoState extends State<Booth42Info> {
