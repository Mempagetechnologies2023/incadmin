...
class Booth36Info extends StatefulWidget {
  const Booth36Info({super.key});

  @override
  State<Booth36Info> createState() => _Booth36InfoState();
}

class _Booth36InfoState extends State<Booth36Info> {
