...
class Booth25Info extends StatefulWidget {
  const Booth25Info({super.key});

  @override
  State<Booth25Info> createState() => _Booth25InfoState();
}

class _Booth25InfoState extends State<Booth25Info> {
