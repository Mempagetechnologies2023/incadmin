...
class Booth21Info extends StatefulWidget {
  const Booth21Info({super.key});

  @override
  State<Booth21Info> createState() => _Booth21InfoState();
}

class _Booth21InfoState extends State<Booth21Info> {
