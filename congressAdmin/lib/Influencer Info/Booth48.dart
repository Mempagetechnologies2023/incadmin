...
class Booth48Info extends StatefulWidget {
  const Booth48Info({super.key});

  @override
  State<Booth48Info> createState() => _Booth48InfoState();
}

class _Booth48InfoState extends State<Booth48Info> {
