...
class Booth26Info extends StatefulWidget {
  const Booth26Info({super.key});

  @override
  State<Booth26Info> createState() => _Booth26InfoState();
}

class _Booth26InfoState extends State<Booth26Info> {
