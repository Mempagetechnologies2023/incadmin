...
class BoothNineInfo extends StatefulWidget {
  const BoothNineInfo({super.key});

  @override
  State<BoothNineInfo> createState() => _BoothNineInfoState();
}

class _BoothNineInfoState extends State<BoothNineInfo> {
