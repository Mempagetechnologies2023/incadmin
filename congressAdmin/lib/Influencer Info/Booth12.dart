...
class Booth12Info extends StatefulWidget {
  const Booth12Info({super.key});

  @override
  State<Booth12Info> createState() => _Booth12InfoState();
}

class _Booth12InfoState extends State<Booth12Info> {
