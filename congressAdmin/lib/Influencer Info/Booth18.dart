...
class Booth18Info extends StatefulWidget {
  const Booth18Info({super.key});

  @override
  State<Booth18Info> createState() => _Booth18InfoState();
}

class _Booth18InfoState extends State<Booth18Info> {
