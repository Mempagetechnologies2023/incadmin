...
class Booth31Info extends StatefulWidget {
  const Booth31Info({super.key});

  @override
  State<Booth31Info> createState() => _Booth31InfoState();
}

class _Booth31InfoState extends State<Booth31Info> {
