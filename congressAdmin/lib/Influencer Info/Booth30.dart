...
class Booth30Info extends StatefulWidget {
  const Booth30Info({super.key});

  @override
  State<Booth30Info> createState() => _Booth30InfoState();
}

class _Booth30InfoState extends State<Booth30Info> {
