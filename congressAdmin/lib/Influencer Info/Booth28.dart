...
class Booth28Info extends StatefulWidget {
  const Booth28Info({super.key});

  @override
  State<Booth28Info> createState() => _Booth28InfoState();
}

class _Booth28InfoState extends State<Booth28Info> {
