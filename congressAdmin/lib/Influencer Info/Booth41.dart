...
class Booth41Info extends StatefulWidget {
  const Booth41Info({super.key});

  @override
  State<Booth41Info> createState() => _Booth41InfoState();
}

class _Booth41InfoState extends State<Booth41Info> {
