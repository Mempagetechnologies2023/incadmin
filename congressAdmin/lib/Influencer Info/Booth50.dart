...
class Booth50Info extends StatefulWidget {
  const Booth50Info({super.key});

  @override
  State<Booth50Info> createState() => _Booth50InfoState();
}

class _Booth50InfoState extends State<Booth50Info> {
