...
class Booth39Info extends StatefulWidget {
  const Booth39Info({super.key});

  @override
  State<Booth39Info> createState() => _Booth39InfoState();
}

class _Booth39InfoState extends State<Booth39Info> {
