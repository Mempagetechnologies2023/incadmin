...
class Booth14Info extends StatefulWidget {
  const Booth14Info({super.key});

  @override
  State<Booth14Info> createState() => _Booth14InfoState();
}

class _Booth14InfoState extends State<Booth14Info> {
