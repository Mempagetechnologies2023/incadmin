...
class Booth32Info extends StatefulWidget {
  const Booth32Info({super.key});

  @override
  State<Booth32Info> createState() => _Booth32InfoState();
}

class _Booth32InfoState extends State<Booth32Info> {
