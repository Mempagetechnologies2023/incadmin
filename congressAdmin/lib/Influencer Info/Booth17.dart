...
class Booth17Info extends StatefulWidget {
  const Booth17Info({super.key});

  @override
  State<Booth17Info> createState() => _Booth17InfoState();
}

class _Booth17InfoState extends State<Booth17Info> {
