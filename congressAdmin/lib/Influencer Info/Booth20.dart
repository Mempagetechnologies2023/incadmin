...
class Booth20Info extends StatefulWidget {
  const Booth20Info({super.key});

  @override
  State<Booth20Info> createState() => _Booth20InfoState();
}

class _Booth20InfoState extends State<Booth20Info> {
