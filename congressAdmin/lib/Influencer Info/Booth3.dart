...
class BoothThreeInfo extends StatefulWidget {
  const BoothThreeInfo({super.key});

  @override
  State<BoothThreeInfo> createState() => _BoothThreeInfoState();
}

class _BoothThreeInfoState extends State<BoothThreeInfo> {
