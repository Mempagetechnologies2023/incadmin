...
class Booth19Info extends StatefulWidget {
  const Booth19Info({super.key});

  @override
  State<Booth19Info> createState() => _Booth19InfoState();
}

class _Booth19InfoState extends State<Booth19Info> {
