...
class Booth46Info extends StatefulWidget {
  const Booth46Info({super.key});

  @override
  State<Booth46Info> createState() => _Booth46InfoState();
}

class _Booth46InfoState extends State<Booth46Info> {
