...
class BoothSevenInfo extends StatefulWidget {
  const BoothSevenInfo({super.key});

  @override
  State<BoothSevenInfo> createState() => _BoothSevenInfoState();
}

class _BoothSevenInfoState extends State<BoothSevenInfo> {
