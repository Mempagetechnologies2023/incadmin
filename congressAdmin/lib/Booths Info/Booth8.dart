...
class BoothEight extends StatefulWidget {
  const BoothEight({super.key});

  @override
  State<BoothEight> createState() => _BoothEightState();
}

class _BoothEightState extends State<BoothEight> {
          ...
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  "$_partytitleText $_partyLeadertitleText 8",
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 25,
                  ),
