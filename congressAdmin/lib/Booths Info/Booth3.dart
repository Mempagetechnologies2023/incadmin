...
class BoothThree extends StatefulWidget {
  const BoothThree({super.key});

  @override
  State<BoothThree> createState() => _BoothThreeState();
}

class _BoothThreeState extends State<BoothThree> {
          ...
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  "$_partytitleText $_partyLeadertitleText 3",
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 25,
                  ),
