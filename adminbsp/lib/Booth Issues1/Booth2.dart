...
class BoothTwoIssues extends StatefulWidget {
  const BoothTwoIssues({super.key});

  @override
  State<BoothTwoIssues> createState() => _BoothTwoIssuesState();
}

class _BoothTwoIssuesState extends State<BoothTwoIssues> {


  final CollectionReference _reference = FirebaseFirestore.instance.collection('booth2');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Booth Issues 2',style: TextStyle(
