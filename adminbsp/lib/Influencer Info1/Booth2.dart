...
class BoothTwoInfo extends StatefulWidget {
  const BoothTwoInfo({super.key});

  @override
  State<BoothTwoInfo> createState() => _BoothTwoInfoState();
}

class _BoothTwoInfoState extends State<BoothTwoInfo> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth2');
