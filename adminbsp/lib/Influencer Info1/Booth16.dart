...
class Booth16Info extends StatefulWidget {
  const Booth16Info({super.key});

  @override
  State<Booth16Info> createState() => _Booth16InfoState();
}

class _Booth16InfoState extends State<Booth16Info> {
