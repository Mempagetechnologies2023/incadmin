...
class Booth24 extends StatefulWidget {
  const Booth24({super.key});

  @override
  State<Booth24> createState() => _Booth24State();
}

class _Booth24State extends State<Booth24> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 24'),
      ),
      body: ListView(
        children: [
          Stack(
