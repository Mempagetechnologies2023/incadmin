...
class Booth39 extends StatefulWidget {
  const Booth39({super.key});

  @override
  State<Booth39> createState() => _Booth39State();
}

class _Booth39State extends State<Booth39> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 39'),
      ),
      body: ListView(
        children: [
          Stack(
