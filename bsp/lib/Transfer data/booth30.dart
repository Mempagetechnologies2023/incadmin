...
class Booth30 extends StatefulWidget {
  const Booth30({super.key});

  @override
  State<Booth30> createState() => _Booth30State();
}

class _Booth30State extends State<Booth30> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 30'),
      ),
      body: ListView(
        children: [
          Stack(
