...
class Booth32 extends StatefulWidget {
  const Booth32({super.key});

  @override
  State<Booth32> createState() => _Booth32State();
}

class _Booth32State extends State<Booth32> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 32'),
      ),
      body: ListView(
        children: [
          Stack(
