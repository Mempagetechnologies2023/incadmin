...
class Booth41 extends StatefulWidget {
  const Booth41({super.key});

  @override
  State<Booth41> createState() => _Booth41State();
}

class _Booth41State extends State<Booth41> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 41'),
      ),
      body: ListView(
        children: [
          Stack(
