...
class Booth31 extends StatefulWidget {
  const Booth31({super.key});

  @override
  State<Booth31> createState() => _Booth31State();
}

class _Booth31State extends State<Booth31> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 31'),
      ),
      body: ListView(
        children: [
          Stack(
