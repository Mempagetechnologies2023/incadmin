...
class Booth25 extends StatefulWidget {
  const Booth25({super.key});

  @override
  State<Booth25> createState() => _Booth25State();
}

class _Booth25State extends State<Booth25> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 25'),
      ),
      body: ListView(
        children: [
          Stack(
