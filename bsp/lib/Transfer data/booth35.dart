...
class Booth35 extends StatefulWidget {
  const Booth35({super.key});

  @override
  State<Booth35> createState() => _Booth35State();
}

class _Booth35State extends State<Booth35> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 35'),
      ),
      body: ListView(
        children: [
          Stack(
