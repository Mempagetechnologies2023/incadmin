...
class Booth29 extends StatefulWidget {
  const Booth29({super.key});

  @override
  State<Booth29> createState() => _Booth29State();
}

class _Booth29State extends State<Booth29> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 29'),
      ),
      body: ListView(
        children: [
          Stack(
