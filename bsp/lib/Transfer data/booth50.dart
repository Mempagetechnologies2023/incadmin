...
class Booth50 extends StatefulWidget {
  const Booth50({super.key});

  @override
  State<Booth50> createState() => _Booth50State();
}

class _Booth50State extends State<Booth50> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 50'),
      ),
      body: ListView(
        children: [
          Stack(
