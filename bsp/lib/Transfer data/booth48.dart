...
class Booth48 extends StatefulWidget {
  const Booth48({super.key});

  @override
  State<Booth48> createState() => _Booth48State();
}

class _Booth48State extends State<Booth48> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 48'),
      ),
      body: ListView(
        children: [
          Stack(
