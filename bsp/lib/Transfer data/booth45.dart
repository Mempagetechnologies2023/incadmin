...
class Booth45 extends StatefulWidget {
  const Booth45({super.key});

  @override
  State<Booth45> createState() => _Booth45State();
}

class _Booth45State extends State<Booth45> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 45'),
      ),
      body: ListView(
        children: [
          Stack(
