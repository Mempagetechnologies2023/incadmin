...
class Booth40 extends StatefulWidget {
  const Booth40({super.key});

  @override
  State<Booth40> createState() => _Booth40State();
}

class _Booth40State extends State<Booth40> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 40'),
      ),
      body: ListView(
        children: [
          Stack(
