...
class Booth34 extends StatefulWidget {
  const Booth34({super.key});

  @override
  State<Booth34> createState() => _Booth34State();
}

class _Booth34State extends State<Booth34> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 34'),
      ),
      body: ListView(
        children: [
          Stack(
