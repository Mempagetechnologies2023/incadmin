...
class Booth27 extends StatefulWidget {
  const Booth27({super.key});

  @override
  State<Booth27> createState() => _Booth27State();
}

class _Booth27State extends State<Booth27> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 27'),
      ),
      body: ListView(
        children: [
          Stack(
