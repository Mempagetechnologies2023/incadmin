...
class Booth49 extends StatefulWidget {
  const Booth49({super.key});

  @override
  State<Booth49> createState() => _Booth49State();
}

class _Booth49State extends State<Booth49> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 49'),
      ),
      body: ListView(
        children: [
          Stack(
