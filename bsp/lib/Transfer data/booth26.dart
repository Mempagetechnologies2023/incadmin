...
class Booth26 extends StatefulWidget {
  const Booth26({super.key});

  @override
  State<Booth26> createState() => _Booth26State();
}

class _Booth26State extends State<Booth26> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 26'),
      ),
      body: ListView(
        children: [
          Stack(
