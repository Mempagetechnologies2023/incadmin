...
class Booth37 extends StatefulWidget {
  const Booth37({super.key});

  @override
  State<Booth37> createState() => _Booth37State();
}

class _Booth37State extends State<Booth37> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 37'),
      ),
      body: ListView(
        children: [
          Stack(
