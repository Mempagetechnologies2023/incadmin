...
class Booth38 extends StatefulWidget {
  const Booth38({super.key});

  @override
  State<Booth38> createState() => _Booth38State();
}

class _Booth38State extends State<Booth38> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 38'),
      ),
      body: ListView(
        children: [
          Stack(
