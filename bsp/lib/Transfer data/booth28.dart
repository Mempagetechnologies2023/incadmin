...
class Booth28 extends StatefulWidget {
  const Booth28({super.key});

  @override
  State<Booth28> createState() => _Booth28State();
}

class _Booth28State extends State<Booth28> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 28'),
      ),
      body: ListView(
        children: [
          Stack(
