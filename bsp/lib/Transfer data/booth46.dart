...
class Booth46 extends StatefulWidget {
  const Booth46({super.key});

  @override
  State<Booth46> createState() => _Booth46State();
}

class _Booth46State extends State<Booth46> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 46'),
      ),
      body: ListView(
        children: [
          Stack(
