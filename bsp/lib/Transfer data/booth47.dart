...
class Booth47 extends StatefulWidget {
  const Booth47({super.key});

  @override
  State<Booth47> createState() => _Booth47State();
}

class _Booth47State extends State<Booth47> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 47'),
      ),
      body: ListView(
        children: [
          Stack(
