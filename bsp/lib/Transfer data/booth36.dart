...
class Booth36 extends StatefulWidget {
  const Booth36({super.key});

  @override
  State<Booth36> createState() => _Booth36State();
}

class _Booth36State extends State<Booth36> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 36'),
      ),
      body: ListView(
        children: [
          Stack(
