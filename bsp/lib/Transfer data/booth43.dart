...
class Booth43 extends StatefulWidget {
  const Booth43({super.key});

  @override
  State<Booth43> createState() => _Booth43State();
}

class _Booth43State extends State<Booth43> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 43'),
      ),
      body: ListView(
        children: [
          Stack(
