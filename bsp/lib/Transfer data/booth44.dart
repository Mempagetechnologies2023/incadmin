...
class Booth44 extends StatefulWidget {
  const Booth44({super.key});

  @override
  State<Booth44> createState() => _Booth44State();
}

class _Booth44State extends State<Booth44> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 44'),
      ),
      body: ListView(
        children: [
          Stack(
