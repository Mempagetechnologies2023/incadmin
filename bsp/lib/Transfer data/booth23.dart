...
class Booth23 extends StatefulWidget {
  const Booth23({super.key});

  @override
  State<Booth23> createState() => _Booth23State();
}

class _Booth23State extends State<Booth23> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 23'),
      ),
      body: ListView(
        children: [
          Stack(
