...
class Booth21 extends StatefulWidget {
  const Booth21({super.key});

  @override
  State<Booth21> createState() => _Booth21State();
}

class _Booth21State extends State<Booth21> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 21'),
      ),
      body: ListView(
        children: [
          Stack(
