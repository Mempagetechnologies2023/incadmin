...
class Booth22 extends StatefulWidget {
  const Booth22({super.key});

  @override
  State<Booth22> createState() => _Booth22State();
}

class _Booth22State extends State<Booth22> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 22'),
      ),
      body: ListView(
        children: [
          Stack(
