...
class Booth42 extends StatefulWidget {
  const Booth42({super.key});

  @override
  State<Booth42> createState() => _Booth42State();
}

class _Booth42State extends State<Booth42> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        title: const Text('User Info booth 42'),
      ),
      body: ListView(
        children: [
          Stack(
