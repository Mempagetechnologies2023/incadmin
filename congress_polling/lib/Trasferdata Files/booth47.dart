...
class TransferDataBooth47 extends StatefulWidget {
  const TransferDataBooth47({super.key});

  @override
  State<TransferDataBooth47> createState() => _TransferDataBooth47State();
}

class _TransferDataBooth47State extends State<TransferDataBooth47> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth47');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 47",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
