...
class TransferDataBooth18 extends StatefulWidget {
  const TransferDataBooth18({super.key});

  @override
  State<TransferDataBooth18> createState() => _TransferDataBooth18State();
}

class _TransferDataBooth18State extends State<TransferDataBooth18> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth18');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 18",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
