...
class TransferDataBooth43 extends StatefulWidget {
  const TransferDataBooth43({super.key});

  @override
  State<TransferDataBooth43> createState() => _TransferDataBooth43State();
}

class _TransferDataBooth43State extends State<TransferDataBooth43> {
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 43",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
