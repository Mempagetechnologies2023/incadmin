...
class TransferDataBooth2 extends StatefulWidget {
  const TransferDataBooth2({super.key});

  @override
  State<TransferDataBooth2> createState() => _TransferDataBooth2State();
}

class _TransferDataBooth2State extends State<TransferDataBooth2> {
  ...
  String _partyLastNametitleText = 'उपनाम';
  ...
  String _partySubmittitleText = 'जमा करना';
  String _partyFilltitleText = 'प्रपत्र भरिये';
  ...
  void _updateSubmitTitleText() {
    switch (_selectedLocale.languageCode) {
      case 'hi':
        _partySubmittitleText = 'जमा करना';
        break;
      case 'en':
        _partySubmittitleText = 'Submit';
        break;
      default:
        _partySubmittitleText = 'जमा करना';
    }
  ...
  void _updateFillTitleText() {
    switch (_selectedLocale.languageCode) {
      case 'hi':
        _partyFilltitleText = 'प्रपत्र भरिये';
        break;
      case 'en':
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 2",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
