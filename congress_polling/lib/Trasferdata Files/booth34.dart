...
class TransferDataBooth34 extends StatefulWidget {
  const TransferDataBooth34({super.key});

  @override
  State<TransferDataBooth34> createState() => _TransferDataBooth34State();
}

class _TransferDataBooth34State extends State<TransferDataBooth34> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth34');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 34",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
