...
class TransferDataBooth50 extends StatefulWidget {
  const TransferDataBooth50({super.key});

  @override
  State<TransferDataBooth50> createState() => _TransferDataBooth50State();
}

class _TransferDataBooth50State extends State<TransferDataBooth50> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth50');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 50",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
