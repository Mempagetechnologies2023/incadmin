...
class TransferDataBooth33 extends StatefulWidget {
  const TransferDataBooth33({super.key});

  @override
  State<TransferDataBooth33> createState() => _TransferDataBooth33State();
}

class _TransferDataBooth33State extends State<TransferDataBooth33> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth33');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 33",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
