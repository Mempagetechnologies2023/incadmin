...
class TransferDataBooth7 extends StatefulWidget {
  const TransferDataBooth7({super.key});

  @override
  State<TransferDataBooth7> createState() => _TransferDataBooth7State();
}

class _TransferDataBooth7State extends State<TransferDataBooth7> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth7');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 7",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
