...
class TransferDataBooth44 extends StatefulWidget {
  const TransferDataBooth44({super.key});

  @override
  State<TransferDataBooth44> createState() => _TransferDataBooth44State();
}

class _TransferDataBooth44State extends State<TransferDataBooth44> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth44');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 44",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
