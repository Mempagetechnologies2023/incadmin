...
class TransferDataBooth30 extends StatefulWidget {
  const TransferDataBooth30({super.key});

  @override
  State<TransferDataBooth30> createState() => _TransferDataBooth30State();
}

class _TransferDataBooth30State extends State<TransferDataBooth30> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth30');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 30",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
