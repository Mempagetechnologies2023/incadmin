...
class TransferDataBooth46 extends StatefulWidget {
  const TransferDataBooth46({super.key});

  @override
  State<TransferDataBooth46> createState() => _TransferDataBooth46State();
}

class _TransferDataBooth46State extends State<TransferDataBooth46> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth46');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 46",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
