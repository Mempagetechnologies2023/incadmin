...
class TransferDataBooth31 extends StatefulWidget {
  const TransferDataBooth31({super.key});

  @override
  State<TransferDataBooth31> createState() => _TransferDataBooth31State();
}

class _TransferDataBooth31State extends State<TransferDataBooth31> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth31');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 31",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
