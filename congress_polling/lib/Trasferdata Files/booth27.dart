...
class TransferDataBooth27 extends StatefulWidget {
  const TransferDataBooth27({super.key});

  @override
  State<TransferDataBooth27> createState() => _TransferDataBooth27State();
}

class _TransferDataBooth27State extends State<TransferDataBooth27> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth27');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 27",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
