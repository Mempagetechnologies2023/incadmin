...
class TransferDataBooth8 extends StatefulWidget {
  const TransferDataBooth8({super.key});

  @override
  State<TransferDataBooth8> createState() => _TransferDataBooth8State();
}

class _TransferDataBooth8State extends State<TransferDataBooth8> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth8');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 8",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
