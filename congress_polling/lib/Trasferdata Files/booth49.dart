...
class TransferDataBooth49 extends StatefulWidget {
  const TransferDataBooth49({super.key});

  @override
  State<TransferDataBooth49> createState() => _TransferDataBooth49State();
}

class _TransferDataBooth49State extends State<TransferDataBooth49> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth49');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 49",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
