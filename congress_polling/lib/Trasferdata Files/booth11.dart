...
class TransferDataBooth11 extends StatefulWidget {
  const TransferDataBooth11({super.key});

  @override
  State<TransferDataBooth11> createState() => _TransferDataBooth11State();
}

class _TransferDataBooth11State extends State<TransferDataBooth11> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth11');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 11",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
