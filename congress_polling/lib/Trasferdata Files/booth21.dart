...
class TransferDataBooth21 extends StatefulWidget {
  const TransferDataBooth21({super.key});

  @override
  State<TransferDataBooth21> createState() => _TransferDataBooth21State();
}

class _TransferDataBooth21State extends State<TransferDataBooth21> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth21');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 21",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
