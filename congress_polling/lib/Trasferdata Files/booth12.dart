...
class TransferDataBooth12 extends StatefulWidget {
  const TransferDataBooth12({super.key});

  @override
  State<TransferDataBooth12> createState() => _TransferDataBooth12State();
}

class _TransferDataBooth12State extends State<TransferDataBooth12> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth12');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 12",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
