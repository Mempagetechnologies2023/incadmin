...
class TransferDataBooth16 extends StatefulWidget {
  const TransferDataBooth16({super.key});

  @override
  State<TransferDataBooth16> createState() => _TransferDataBooth16State();
}

class _TransferDataBooth16State extends State<TransferDataBooth16> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth16');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 16",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
