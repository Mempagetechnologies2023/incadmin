...
class TransferDataBooth48 extends StatefulWidget {
  const TransferDataBooth48({super.key});

  @override
  State<TransferDataBooth48> createState() => _TransferDataBooth48State();
}

class _TransferDataBooth48State extends State<TransferDataBooth48> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth48');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 48",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
