...
class TransferDataBooth20 extends StatefulWidget {
  const TransferDataBooth20({super.key});

  @override
  State<TransferDataBooth20> createState() => _TransferDataBooth20State();
}

class _TransferDataBooth20State extends State<TransferDataBooth20> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth20');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 20",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
