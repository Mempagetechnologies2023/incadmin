...
class TransferDataBooth26 extends StatefulWidget {
  const TransferDataBooth26({super.key});

  @override
  State<TransferDataBooth26> createState() => _TransferDataBooth26State();
}

class _TransferDataBooth26State extends State<TransferDataBooth26> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth26');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 26",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
