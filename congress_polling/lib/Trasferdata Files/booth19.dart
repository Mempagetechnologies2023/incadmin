...
class TransferDataBooth19 extends StatefulWidget {
  const TransferDataBooth19({super.key});

  @override
  State<TransferDataBooth19> createState() => _TransferDataBooth19State();
}

class _TransferDataBooth19State extends State<TransferDataBooth19> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth19');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 19",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
