...
class TransferDataBooth39 extends StatefulWidget {
  const TransferDataBooth39({super.key});

  @override
  State<TransferDataBooth39> createState() => _TransferDataBooth39State();
}

class _TransferDataBooth39State extends State<TransferDataBooth39> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth39');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 39",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
