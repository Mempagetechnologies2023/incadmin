...
class TransferDataBooth41 extends StatefulWidget {
  const TransferDataBooth41({super.key});

  @override
  State<TransferDataBooth41> createState() => _TransferDataBooth41State();
}

class _TransferDataBooth41State extends State<TransferDataBooth41> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth41');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 41",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
