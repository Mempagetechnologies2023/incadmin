...
class TransferDataBooth9 extends StatefulWidget {
  const TransferDataBooth9({super.key});

  @override
  State<TransferDataBooth9> createState() => _TransferDataBooth9State();
}

class _TransferDataBooth9State extends State<TransferDataBooth9> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth9');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 9",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
