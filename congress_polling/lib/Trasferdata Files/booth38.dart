...
class TransferDataBooth38 extends StatefulWidget {
  const TransferDataBooth38({super.key});

  @override
  State<TransferDataBooth38> createState() => _TransferDataBooth38State();
}

class _TransferDataBooth38State extends State<TransferDataBooth38> {
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 38",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
