...
class TransferDataBooth3 extends StatefulWidget {
  const TransferDataBooth3({super.key});

  @override
  State<TransferDataBooth3> createState() => _TransferDataBooth3State();
}

class _TransferDataBooth3State extends State<TransferDataBooth3> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth3');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 3",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
