...
class TransferDataBooth14 extends StatefulWidget {
  const TransferDataBooth14({super.key});

  @override
  State<TransferDataBooth14> createState() => _TransferDataBooth14State();
}

class _TransferDataBooth14State extends State<TransferDataBooth14> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth14');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 14",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
