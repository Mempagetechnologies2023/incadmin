...
class TransferDataBooth35 extends StatefulWidget {
  const TransferDataBooth35({super.key});

  @override
  State<TransferDataBooth35> createState() => _TransferDataBooth35State();
}

class _TransferDataBooth35State extends State<TransferDataBooth35> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth35');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 35",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
