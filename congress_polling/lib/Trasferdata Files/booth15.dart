...
class TransferDataBooth15 extends StatefulWidget {
  const TransferDataBooth15({super.key});

  @override
  State<TransferDataBooth15> createState() => _TransferDataBooth15State();
}

class _TransferDataBooth15State extends State<TransferDataBooth15> {
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 15",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
