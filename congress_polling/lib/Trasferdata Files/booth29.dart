...
class TransferDataBooth29 extends StatefulWidget {
  const TransferDataBooth29({super.key});

  @override
  State<TransferDataBooth29> createState() => _TransferDataBooth29State();
}

class _TransferDataBooth29State extends State<TransferDataBooth29> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth29');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 29",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
