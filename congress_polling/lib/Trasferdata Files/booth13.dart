...
class TransferDataBooth13 extends StatefulWidget {
  const TransferDataBooth13({super.key});

  @override
  State<TransferDataBooth13> createState() => _TransferDataBooth13State();
}

class _TransferDataBooth13State extends State<TransferDataBooth13> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth13');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 13",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
