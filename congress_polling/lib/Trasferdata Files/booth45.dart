...
class TransferDataBooth45 extends StatefulWidget {
  const TransferDataBooth45({super.key});

  @override
  State<TransferDataBooth45> createState() => _TransferDataBooth45State();
}

class _TransferDataBooth45State extends State<TransferDataBooth45> {
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 45",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
