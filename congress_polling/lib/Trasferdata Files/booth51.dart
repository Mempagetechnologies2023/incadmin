...
class TransferDataBooth51 extends StatefulWidget {
  const TransferDataBooth51({super.key});

  @override
  State<TransferDataBooth51> createState() => _TransferDataBooth51State();
}

class _TransferDataBooth51State extends State<TransferDataBooth51> {
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 51",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
