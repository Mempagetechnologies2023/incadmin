...
class TransferDataBooth6 extends StatefulWidget {
  const TransferDataBooth6({super.key});

  @override
  State<TransferDataBooth6> createState() => _TransferDataBooth6State();
}

class _TransferDataBooth6State extends State<TransferDataBooth6> {
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 6",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
