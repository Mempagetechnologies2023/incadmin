...
class TransferDataBooth32 extends StatefulWidget {
  const TransferDataBooth32({super.key});

  @override
  State<TransferDataBooth32> createState() => _TransferDataBooth32State();
}

class _TransferDataBooth32State extends State<TransferDataBooth32> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth32');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 32",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
