...
class TransferDataBooth17 extends StatefulWidget {
  const TransferDataBooth17({super.key});

  @override
  State<TransferDataBooth17> createState() => _TransferDataBooth17State();
}

class _TransferDataBooth17State extends State<TransferDataBooth17> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth17');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 17",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
