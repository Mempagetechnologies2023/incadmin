...
class TransferDataBooth37 extends StatefulWidget {
  const TransferDataBooth37({super.key});

  @override
  State<TransferDataBooth37> createState() => _TransferDataBooth37State();
}

class _TransferDataBooth37State extends State<TransferDataBooth37> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth37');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 37",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
