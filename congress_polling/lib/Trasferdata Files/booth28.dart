...
class TransferDataBooth28 extends StatefulWidget {
  const TransferDataBooth28({super.key});

  @override
  State<TransferDataBooth28> createState() => _TransferDataBooth28State();
}

class _TransferDataBooth28State extends State<TransferDataBooth28> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth28');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 28",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
