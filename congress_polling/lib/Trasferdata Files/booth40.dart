...
class TransferDataBooth40 extends StatefulWidget {
  const TransferDataBooth40({super.key});

  @override
  State<TransferDataBooth40> createState() => _TransferDataBooth40State();
}

class _TransferDataBooth40State extends State<TransferDataBooth40> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth40');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 40",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
