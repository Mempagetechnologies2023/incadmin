...
class TransferDataBooth22 extends StatefulWidget {
  const TransferDataBooth22({super.key});

  @override
  State<TransferDataBooth22> createState() => _TransferDataBooth22State();
}

class _TransferDataBooth22State extends State<TransferDataBooth22> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth22');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 22",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
