...
class TransferDataBooth25 extends StatefulWidget {
  const TransferDataBooth25({super.key});

  @override
  State<TransferDataBooth25> createState() => _TransferDataBooth25State();
}

class _TransferDataBooth25State extends State<TransferDataBooth25> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth25');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 25",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
