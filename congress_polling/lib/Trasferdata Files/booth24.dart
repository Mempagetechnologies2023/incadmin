...
class TransferDataBooth24 extends StatefulWidget {
  const TransferDataBooth24({super.key});

  @override
  State<TransferDataBooth24> createState() => _TransferDataBooth24State();
}

class _TransferDataBooth24State extends State<TransferDataBooth24> {
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 24",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
