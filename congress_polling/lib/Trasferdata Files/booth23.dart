...
class TransferDataBooth23 extends StatefulWidget {
  const TransferDataBooth23({super.key});

  @override
  State<TransferDataBooth23> createState() => _TransferDataBooth23State();
}

class _TransferDataBooth23State extends State<TransferDataBooth23> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth23');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 23",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
