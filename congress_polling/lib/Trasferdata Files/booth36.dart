...
class TransferDataBooth36 extends StatefulWidget {
  const TransferDataBooth36({super.key});

  @override
  State<TransferDataBooth36> createState() => _TransferDataBooth36State();
}

class _TransferDataBooth36State extends State<TransferDataBooth36> {
  final CollectionReference _reference =
  FirebaseFirestore.instance.collection('booth36');
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Text(
                        "$_partyBoothtitleText 36",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900),
                      ),
                    ),
                    Positioned(
