...
//
//
final Uri _urlINCwebIndhira = Uri.parse('https://inc.in/our-inspiration/smt-indira-gandhi');
final Uri _urlINCwebRahul = Uri.parse('https://www.inc.in/leadership/past-party-presidents/shri-rahul-gandhi');
final Uri _urlINCwebRajiv = Uri.parse('https://inc.in/our-inspiration/shri-rajiv-gandhi');
final Uri _urlINCwebManmohan = Uri.parse('https://inc.in/our-inspiration/dr-manmohan-singh');
...
final Uri _urlRahulFaceBook = Uri.parse('https://www.facebook.com/rahulgandhi/');
final Uri _urlRahulTwitter = Uri.parse('https://twitter.com/rahulgandhi?lang=en');
final Uri _urlRahulInstagram = Uri.parse('https://www.instagram.com/rahulgandhi/?hl=en');

final Uri _urlSoniyaFaceBook = Uri.parse('https://www.facebook.com/SoniaRajivGandhi/');

final Uri _urlPriyankaFaceBook = Uri.parse('https://www.facebook.com/priyankagandhivadra/');

final Uri _urlIndhiraFaceBook = Uri.parse('https://www.facebook.com/IndiraPriyadarshiniGandhi/');

final Uri _urlRajivFaceBook = Uri.parse('https://www.facebook.com/rajivgandhi/');

final Uri _urlManmohanFaceBook = Uri.parse('https://www.facebook.com/dr.manmohansingh/');
...
class _LeadersScreenState extends State<LeadersScreen> {
  ...
  // String _partytitleText = 'Indian National Congress';
  ...
  String _partydrawerRahulText = 'राहुल गांधी';
  String _partydrawerRahulRoleText = 'भारतीय राष्ट्रीय कांग्रेस के अध्यक्ष';

  String _partydrawerSoniyaText = 'सोनिया गांधी';
  String _partydrawerSoniyaRoleText = 'भारतीय राष्ट्रीय कांग्रेस के पूर्व अध्यक्ष';

  String _partydrawerPriyankaText = 'प्रियंका गांधी';
  String _partydrawerPriyankaRoleText = 'उत्तर प्रदेश में एआईसीसी के महासचिव';

  String _partydrawerIndhiraText = 'इंदिरा प्रियदर्शनी गांधी';
  String _partydrawerIndhiraRoleText = 'भारत के तीसरे प्रधान मंत्री';

  String _partydrawerRajivText = 'राजीव गांधी';
  String _partydrawerRajivRoleText = 'भारत के छठे प्रधान मंत्री';

  String _partydrawerMohanText = 'मनमोहन सिंह';
  String _partydrawerMohanRoleText = 'भारत के 13वें प्रधान मंत्री';
  ...
  void _changeLanguage(Locale newLocale) {
    setState(() {
      ...
      //leaders
      _updateLeaderRahulText();
      _updateLeaderRahulRoleText();

      _updateLeaderSoniyaText();
      _updateLeaderSoniyaRoleText();

      _updateLeaderPriyankaText();
      _updateLeaderPriyankaRoleText();

      _updateLeaderIndhiraText();
      _updateLeaderIndhiraRoleText();

      _updateLeaderRajivText();
      _updateLeaderRajivRoleText();

      _updateLeaderMohanText();
      _updateLeaderMohanRoleText();
  ...
  //leaders
  void _updateLeaderRahulRoleText() {
    switch (_selectedLocale.languageCode) {
      case 'hi':
        _partydrawerRahulText = 'राहुल गांधी';
        break;
      case 'en':
        _partydrawerRahulText = 'Rahul Gandhi';
        break;
      default:
        _partydrawerRahulText = 'राहुल गांधी';
    }
  }
  void _updateLeaderRahulText() {
    switch (_selectedLocale.languageCode) {
      case 'hi':
        _partydrawerRahulRoleText = 'भारतीय राष्ट्रीय कांग्रेस के अध्यक्ष';
        break;
      case 'en':
        _partydrawerRahulRoleText = 'President of the Indian National Congress';
        break;
      default:
        _partydrawerRahulRoleText = 'भारतीय राष्ट्रीय कांग्रेस के अध्यक्ष';
    }
  ...
  void _updateLeaderSoniyaText() {
    switch (_selectedLocale.languageCode) {
      case 'hi':
        _partydrawerSoniyaText = 'सोनिया गांधी';
        break;
      case 'en':
        _partydrawerSoniyaText = 'Sonia Gandhi';
        break;
      default:
        _partydrawerSoniyaText = 'सोनिया गांधी';
    }
  }
  void _updateLeaderSoniyaRoleText() {
    switch (_selectedLocale.languageCode) {
      case 'hi':
        _partydrawerSoniyaRoleText = 'भारतीय राष्ट्रीय कांग्रेस के पूर्व अध्यक्ष';
        break;
      case 'en':
        _partydrawerSoniyaRoleText = 'Ex President of the Indian National Congress';
        break;
      default:
        _partydrawerSoniyaRoleText = 'भारतीय राष्ट्रीय कांग्रेस के पूर्व अध्यक्ष';
    }
  ...
  void _updateLeaderPriyankaText() {
    switch (_selectedLocale.languageCode) {
      case 'hi':
        _partydrawerPriyankaText = 'प्रियंका गांधी';
        break;
      case 'en':
        _partydrawerPriyankaText = 'Priyanka Gandhi';
        break;
      default:
        _partydrawerPriyankaText = 'प्रियंका गांधी';
    }
  }
  void _updateLeaderPriyankaRoleText() {
    switch (_selectedLocale.languageCode) {
      case 'hi':
        _partydrawerPriyankaRoleText = 'उत्तर प्रदेश में एआईसीसी के महासचिव';
        break;
      case 'en':
        _partydrawerPriyankaRoleText = 'General Secretary of the AICC in Uttar Pradesh';
        break;
      default:
        _partydrawerPriyankaRoleText = 'उत्तर प्रदेश में एआईसीसी के महासचिव';
    }
  ...
  void _updateLeaderIndhiraText() {
    switch (_selectedLocale.languageCode) {
      case 'hi':
        _partydrawerIndhiraText = 'पइंदिरा प्रियदर्शनी गांधी';
        break;
      case 'en':
        _partydrawerIndhiraText = 'Indira Priyadarshini Gandhi ';
        break;
      default:
        _partydrawerIndhiraText = 'इंदिरा प्रियदर्शनी गांधी';
    }
  }
  void _updateLeaderIndhiraRoleText() {
    switch (_selectedLocale.languageCode) {
      case 'hi':
        _partydrawerIndhiraRoleText = 'भारत के तीसरे प्रधान मंत्री';
        break;
      case 'en':
        _partydrawerIndhiraRoleText = '3rd Prime Minister of India';
        break;
      default:
        _partydrawerIndhiraRoleText = 'भारत के तीसरे प्रधान मंत्री';
    }
  ...
  void _updateLeaderRajivText() {
    switch (_selectedLocale.languageCode) {
      case 'hi':
        _partydrawerRajivText = 'राजीव गांधी';
        break;
      case 'en':
        _partydrawerRajivText = 'Rajiv Gandhi ';
        break;
      default:
        _partydrawerRajivText = 'राजीव गांधी';
    }
  }
  void _updateLeaderRajivRoleText() {
    switch (_selectedLocale.languageCode) {
      case 'hi':
        _partydrawerRajivRoleText = 'भारत के छठे प्रधान मंत्री';
        break;
      case 'en':
        _partydrawerRajivRoleText = '6th Prime Minister of India';
        break;
      default:
        _partydrawerRajivRoleText = 'भारत के छठे प्रधान मंत्री';
    }
  ...
  void _updateLeaderMohanText() {
    switch (_selectedLocale.languageCode) {
      case 'hi':
        _partydrawerMohanText = 'मनमोहन सिंह';
        break;
      case 'en':
        _partydrawerMohanText = 'Manmohan Singh';
        break;
      default:
        _partydrawerMohanText = 'मनमोहन सिंह';
    }
  }
  void _updateLeaderMohanRoleText() {
    switch (_selectedLocale.languageCode) {
      case 'hi':
        _partydrawerMohanRoleText = 'भारत के 13वें प्रधान मंत्री';
        break;
      case 'en':
        _partydrawerMohanRoleText = '13th Prime Minister of India';
        break;
      default:
        _partydrawerMohanRoleText = 'भारत के 13वें प्रधान मंत्री';
    }
            ...
            Column(mainAxisAlignment: MainAxisAlignment.center, children: [
              Container(
                child: GFCard(
                  ...
                  showImage: true,
                  title: GFListTile(
                    onLongPress:_launchUrlwebRahul,
                    avatar: GFAvatar(
                      backgroundImage:
                      AssetImage('assets/Leaders/rahul.jpg'),
                    ),
                    titleText: _partydrawerRahulText,
                    subTitleText: '',
                    onTap: _launchUrlwebRahul,
                  ),
                  content: Text(
                    _partydrawerRahulRoleText,style: TextStyle(fontWeight: FontWeight.w900,),
                  ),

                  buttonBar: GFButtonBar(
                    children: <Widget>[
                      // GFButton(
                      // onPressed: _launchUrlnarendramodifacebook,
                      // text: "Facebook",
                      // icon: Icon(Icons.facebook),
                      // shape: GFButtonShape.pills,
                      // ),
                      GFButton(
                        onPressed: _launchUrlRahulTwitter,
                        text: "Twitter",
                      ...
                      GFButton(
                        onPressed: _launchUrlRahulInstagram,
                        text: "Instagram",
                      ...
                      GFButton(
                        onPressed: _launchUrlRahulFaceBook,
                        text: "FaceBook",
                        icon: Icon(Icons.facebook),
                        color: Colors.green,
                        shape: GFButtonShape.pills,
              ...
              Container(
                child: GFCard(
                  ...
                  showImage: true,
                  title: GFListTile(
                    onLongPress: _launchUrlSoniya,
                    avatar: GFAvatar(
                      backgroundImage:
                      AssetImage('assets/Leaders/soniya.jpg'),
                    ),
                    titleText: _partydrawerSoniyaText,
                    onTap: _launchUrlSoniya,
                  ),
                  content: Text(_partydrawerSoniyaRoleText,style: TextStyle(fontWeight: FontWeight.w900,),),
                  buttonBar: GFButtonBar(
                    children: <Widget>[
                      SizedBox(
                        width: 120,
                        child: ElevatedButton(
                          onPressed: _launchUrlSoniya,
                          style: ButtonStyle(
                              backgroundColor:
              ...
              Container(
                child: GFCard(
                  ...
                  showImage: true,
                  title: GFListTile(
                    onTap: _launchUrlPriyankaFaceBook,
                    avatar: GFAvatar(
                      backgroundImage: AssetImage('assets/Leaders/priyanka.jpg'),
                    ),
                    titleText: _partydrawerPriyankaText,
                    onLongPress: _launchUrlPriyankaFaceBook,
                  ),
                  content: Text(_partydrawerPriyankaRoleText,style: TextStyle(fontWeight: FontWeight.w900,),),
                  buttonBar: GFButtonBar(
                    children: <Widget>[
                      SizedBox(
                        width: 120,
                        child: ElevatedButton(
                          onPressed: _launchUrlPriyankaFaceBook,
                          style: ButtonStyle(
                              backgroundColor:
                              MaterialStateProperty.all(Colors.green)),
                          child: Padding(
              ...
              Container(
                child: GFCard(
                  ...
                  showImage: true,
                  title: GFListTile(
                    onLongPress: _launchUrlwebIndhira,
                    avatar: GFAvatar(
                      backgroundImage:
                      AssetImage('assets/Leaders/Indhira.jpg'),
                      backgroundColor: Colors.orange,
                    ),
                    titleText: _partydrawerIndhiraText,
                    onTap: _launchUrlwebIndhira,
                  ),
                  content:
                  Text(_partydrawerIndhiraRoleText,style: TextStyle(fontWeight: FontWeight.w900),),
                  buttonBar: GFButtonBar(
                    children: <Widget>[
                      SizedBox(
                        width: 120,
                        child: ElevatedButton(
                          onPressed: _launchUrlIndhiraFaceBook,
                          style: ButtonStyle(
                              backgroundColor:
                              MaterialStateProperty.all(Colors.green)),
                          child: Padding(
              ...
              Container(
                child: GFCard(
                  ...
                  showImage: true,
                  title: GFListTile(
                    onTap: _launchUrlwebRajiv,
                    avatar: GFAvatar(
                      backgroundImage: AssetImage('assets/Leaders/Rajeev.jpg'),
                    ),
                    titleText: _partydrawerRajivText,
                    onLongPress: _launchUrlwebRajiv,
                  ),
                  content: Text(_partydrawerRajivRoleText,style: TextStyle(fontWeight: FontWeight.w900,),),
                  buttonBar: GFButtonBar(
                    children: <Widget>[
                      SizedBox(
                        width: 120,
                        child: ElevatedButton(
                          onPressed: _launchUrlRajivFaceBook,
                          style: ButtonStyle(
                              backgroundColor:
                              MaterialStateProperty.all(Colors.green)),
                          child: Padding(
              ...
              Container(
                child: GFCard(
                  ...
                  showImage: true,
                  title: GFListTile(
                    onTap: _launchUrlwebManmohan,
                    avatar: GFAvatar(
                      backgroundImage: AssetImage('assets/Leaders/manmohan.jpg'),
                    ),
                    titleText: _partydrawerMohanText,
                    onLongPress: _launchUrlwebManmohan,
                  ),
                  content: Text(_partydrawerMohanRoleText,style: TextStyle(fontWeight: FontWeight.w900),),
                  buttonBar: GFButtonBar(
                    children: <Widget>[
                      SizedBox(
                        width: 120,
                        child: ElevatedButton(
                          onPressed: _launchUrlManmohanFaceBook,
                          style: ButtonStyle(
                              backgroundColor:
                              MaterialStateProperty.all(Colors.green)),
                          child: Padding(
...
///
///
Future<void> _launchUrlwebIndhira() async {
  if (!await launchUrl(_urlINCwebIndhira)) {
    throw Exception('Could not launch $_urlINCwebIndhira');
  }
}

Future<void> _launchUrlwebRahul() async {
  if (!await launchUrl(_urlINCwebRahul)) {
    throw Exception('Could not launch $_urlINCwebRahul');
  }
}

Future<void> _launchUrlwebRajiv() async {
  if (!await launchUrl(_urlINCwebRajiv)) {
    throw Exception('Could not launch $_urlINCwebRajiv');
  }
}

Future<void> _launchUrlwebManmohan() async {
  if (!await launchUrl(_urlINCwebManmohan)) {
    throw Exception('Could not launch $_urlINCwebManmohan');
  }
}
...
Future<void> _launchUrlRahulFaceBook() async {
  if (!await launchUrl(_urlRahulFaceBook)) {
    throw Exception('Could not launch $_urlRahulFaceBook');
  }
}
Future<void> _launchUrlRahulTwitter() async {
  if (!await launchUrl(_urlRahulTwitter)) {
    throw Exception('Could not launch $_urlRahulTwitter');
  }
}
Future<void> _launchUrlRahulInstagram() async {
  if (!await launchUrl(_urlRahulInstagram)) {
    throw Exception('Could not launch $_urlRahulInstagram');
  }
}

Future<void> _launchUrlSoniya() async {
  if (!await launchUrl(_urlSoniyaFaceBook)) {
    throw Exception('Could not launch $_urlSoniyaFaceBook');
  }
}

Future<void> _launchUrlPriyankaFaceBook() async {
  if (!await launchUrl(_urlPriyankaFaceBook)) {
    throw Exception('Could not launch $_urlPriyankaFaceBook');
  }
}

Future<void> _launchUrlIndhiraFaceBook() async {
  if (!await launchUrl(_urlIndhiraFaceBook)) {
    throw Exception('Could not launch $_urlIndhiraFaceBook');
  }
}

Future<void> _launchUrlRajivFaceBook() async {
  if (!await launchUrl(_urlRajivFaceBook)) {
    throw Exception('Could not launch $_urlRajivFaceBook');
  }
}

Future<void> _launchUrlManmohanFaceBook() async {
  if (!await launchUrl(_urlManmohanFaceBook)) {
    throw Exception('Could not launch $_urlManmohanFaceBook');
  }
}
